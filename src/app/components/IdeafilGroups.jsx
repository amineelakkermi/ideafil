...
const cards = [
  {
    ...
    subtitle: "أيدفل تك",
    description:
      "نربط الإبداع بالتقنية .. حلول رقمية تدعم التحول الرقمي للعلامات التجارية و تطور تجربة العملاء",
  ...
  {
    id: 2,
    title: "ideafil.design",
    subtitle: "أيدفل ديزاين",
    description:
      "نحوّل الأفكار إلى هويات بصرية وتجارب تصميم ملهمة تعكس قوة علامتك",
    highlight: "الإبداع يصنع الفرق",
    bg: "bg-[#6000C0]",
    logo: technology,
  },
  {
    ...
    description:
      "استراتيجيات تسويق ونمو تضمن لك حضور قوي وتأثير فعّال في السوق",
    highlight: "نصنع النمو بثقة",
    bg: "bg-[#FF0161]",
    logo: impact,
  },
]
